...
for i in range(0,numberofnoises): 
    ...
    # Path templates
    path = current_directory+f'/Angle_180/Noise_{noises[i]}/correlation_data/connectedcorrelation_vs_r_5000_.dat'
    ...
    ax.set_ylabel('$C_{\delta v}(r)$',size=y_label_size)
...
for i in range(0,numberofangles): 
    ...
    # Path templates
    path = current_directory+f'/Angle_{angles[i]}/Noise_{noises[0]}/correlation_data/connectedcorrelation_vs_r_{time[timetoplot]}_.dat'

    if(i==0):
        path = current_directory+f"/Figure/correlation/ccf_vs_r_45_005.dat"
...
for i in range(0,numberofangles): 
    ...
    # Path templates
    path = current_directory+f'/Angle_{angles[i]}/Noise_{noises[1]}/correlation_data/connectedcorrelation_vs_r_{time[timetoplot]}_.dat'
    # Load connected correlation function vs r data
    ccf,r = load_data(path)
...
for i in range(0,numberofangles): 
    ...
    # Path templates
    path = current_directory+f'/Angle_{angles[i]}/Noise_{noises[2]}/correlation_data/connectedcorrelation_vs_r_{time[timetoplot]}_.dat'
    # Load connected correlation function vs r data
    ccf,r = load_data(path)
    # Plot
    ax = axes[1,1]
