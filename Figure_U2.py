...
for j in range(0,numberofangles): 
    for i in range(0,numberofnoises):
        # Path templates
        path = current_directory+f'/Angle_{angles[j]}/Noise_{noises[i]}/Binder_Cumulant/U2_vs_t.dat'
        ...
        if(m==0):
            ax.set_ylabel(r'$U_{2} $',fontsize=25,labelpad=1)
        
        ax.legend(loc="best", prop={'size': 15},labelspacing = 0.2,frameon=False,bbox_to_anchor=(0.46, 0.05, 0.5, 0.5))
